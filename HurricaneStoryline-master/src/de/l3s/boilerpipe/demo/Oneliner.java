...
//        		"http://www.reuters.com/article/2012/11/08/us-usa-campaign-voting-idUSBRE8A71F820121108"
        		);

        // This can also be done in one line:
//         System.out.println(ArticleSentencesExtractor.INSTANCE.getText(url));
        System.out.println(LargestContentExtractor.INSTANCE.getText(url));
